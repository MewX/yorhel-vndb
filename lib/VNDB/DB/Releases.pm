...
sub dbReleaseGet {
  ...
  my @select = (
    ...
    $o{what} =~ /extended/ ? qw|
        ...
        r.l_steam r.l_dlsite r.l_dlsiteen r.l_gog r.l_denpa r.l_jlist r.l_gyutto r.l_digiket r.l_melon r.l_mg r.l_getchu r.l_getchudl
    | : (),
...
sub dbReleaseGetRev {
  ...
  $select .= ', r.l_steam, r.l_dlsite, r.l_dlsiteen, r.l_gog, r.l_denpa, r.l_jlist, r.l_gyutto, r.l_digiket, r.l_melon, r.l_mg, r.l_getchu, r.l_getchudl' if $o{what} =~ /extended/;
